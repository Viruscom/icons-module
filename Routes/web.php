...
Route::group(['prefix' => 'admins', 'middleware' => ['auth']], static function () {
    Route::group(['prefix' => 'icons'], static function () {
        ...
        Route::get('/load-icons/{path}', [IconsController::class, 'loadIconsPage'])->name('admin.icons.manage.load-icons');
        Route::get('/create/{path}', [IconsController::class, 'create'])->name('admin.icons.create');
        Route::post('/store/{path}', [IconsController::class, 'store'])->name('admin.icons.store');
    ...
    Route::group(['prefix' => 'icon-sets'], static function () {
        Route::get('/', [IconSetController::class, 'index'])->name('admin.icon-sets.index');
        Route::get('/create', [IconSetController::class, 'create'])->name('admin.icon-sets.create');
        Route::post('/store', [IconSetController::class, 'store'])->name('admin.icon-sets.store');

        Route::group(['prefix' => 'multiple'], static function () {
            Route::get('active/{active}', [IconSetController::class, 'activeMultiple'])->name('admin.icon-sets.active-multiple');
            Route::get('delete', [IconSetController::class, 'deleteMultiple'])->name('admin.icon-sets.delete-multiple');
        });

        Route::group(['prefix' => '{id}'], static function () {
            Route::get('edit', [IconSetController::class, 'edit'])->name('admin.icon-sets.edit');
            Route::post('update', [IconSetController::class, 'update'])->name('admin.icon-sets.update');
            Route::get('delete', [IconSetController::class, 'delete'])->name('admin.icon-sets.delete');
            Route::get('show', [IconSetController::class, 'show'])->name('admin.icon-sets.show');
            Route::get('/active/{active}', [IconSetController::class, 'active'])->name('admin.icon-sets.changeStatus');
            Route::get('position/up', [IconSetController::class, 'positionUp'])->name('admin.icon-sets.position-up');
            Route::get('position/down', [IconSetController::class, 'positionDown'])->name('admin.icon-sets.position-down');
            Route::get('image/delete', [IconSetController::class, 'deleteImage'])->name('admin.icon-sets.delete-image');
        });
    });
