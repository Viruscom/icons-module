...
class IconTranslation  extends Model implements CommonModelTranslationInterfaces
{
    use StorageActions;

    protected $table    = "icon_translation";
    protected $fillable = ['locale', 'icon_id', 'title', 'url', 'short_description'];
