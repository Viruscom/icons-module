...
@section('content')
    ...
    <div class="col-xs-12 p-0">
        <form class="my-form" action="{{ route('admin.icons.update', ['id' => $icon->id]) }}" method="POST" data-form-type="store" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select class="form-control select2" name="main_position">
                                <option value="{{ Icon::ICONS_AFTER_DESCRIPTION }}" {{ $icon->main_position == Icon::ICONS_AFTER_DESCRIPTION ? 'selected': '' }}>{{ trans('icons::admin.icons.after_main_description') }}</option>
                                <option value="{{ Icon::ICONS_AFTER_ADDITIONAL_DESCRIPTION_1 }}" {{ $icon->main_position == Icon::ICONS_AFTER_ADDITIONAL_DESCRIPTION_1 ? 'selected': '' }}>{{ trans('icons::admin.icons.after_additional_description_1') }}</option>
                                <option value="{{ Icon::ICONS_AFTER_ADDITIONAL_DESCRIPTION_2 }}" {{ $icon->main_position == Icon::ICONS_AFTER_ADDITIONAL_DESCRIPTION_2 ? 'selected': '' }}>{{ trans('icons::admin.icons.after_additional_description_2') }}</option>
                                <option value="{{ Icon::ICONS_AFTER_ADDITIONAL_DESCRIPTION_3 }}" {{ $icon->main_position == Icon::ICONS_AFTER_ADDITIONAL_DESCRIPTION_3 ? 'selected': '' }}>{{ trans('icons::admin.icons.after_additional_description_3') }}</option>
                                <option value="{{ Icon::ICONS_AFTER_ADDITIONAL_DESCRIPTION_4 }}" {{ $icon->main_position == Icon::ICONS_AFTER_ADDITIONAL_DESCRIPTION_4 ? 'selected': '' }}>{{ trans('icons::admin.icons.after_additional_description_4') }}</option>
                                <option value="{{ Icon::ICONS_AFTER_ADDITIONAL_DESCRIPTION_5 }}" {{ $icon->main_position == Icon::ICONS_AFTER_ADDITIONAL_DESCRIPTION_5 ? 'selected': '' }}>{{ trans('icons::admin.icons.after_additional_description_5') }}</option>
                                <option value="{{ Icon::ICONS_AFTER_ADDITIONAL_DESCRIPTION_6 }}" {{ $icon->main_position == Icon::ICONS_AFTER_ADDITIONAL_DESCRIPTION_6 ? 'selected': '' }}>{{ trans('icons::admin.icons.after_additional_description_6') }}</option>
                            </select>
                        </div>
                    </div>
