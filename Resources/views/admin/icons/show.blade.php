...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            <h3>{{ __('icons::admin.icons.after_main_description') }}: <strong>{{ $model->title }}</strong></h3>
    ...
    <div class="row">
        <div class="col-xs-12">
            <h3>{{ __('icons::admin.icons.after_additional_description_1') }}: <strong>{{ $model->title }}</strong></h3>
    ...
    <div class="row">
        <div class="col-xs-12">
            <h3>{{ __('icons::admin.icons.after_additional_description_2') }}: <strong>{{ $model->title }}</strong></h3>
    ...
    <div class="row">
        <div class="col-xs-12">
            <h3>{{ __('icons::admin.icons.after_additional_description_3') }}: <strong>{{ $model->title }}</strong></h3>
    ...
    <div class="row">
        <div class="col-xs-12">
            <h3>{{ __('icons::admin.icons.after_additional_description_4') }}: <strong>{{ $model->title }}</strong></h3>
    ...
    <div class="row">
        <div class="col-xs-12">
            <h3>{{ __('icons::admin.icons.after_additional_description_5') }}: <strong>{{ $model->title }}</strong></h3>
    ...
    <div class="row">
        <div class="col-xs-12">
            <h3>{{ __('icons::admin.icons.after_additional_description_6') }}: <strong>{{ $model->title }}</strong></h3>
